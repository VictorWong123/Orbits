...
- Name: swipe-to-delete.spec.ts >> Profile card swipe-to-delete >> tapping the card (no swipe) navigates to the profile page
- Location: tests/swipe-to-delete.spec.ts:145:7
