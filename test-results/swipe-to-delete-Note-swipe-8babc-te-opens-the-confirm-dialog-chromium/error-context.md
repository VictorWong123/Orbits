...
- Name: swipe-to-delete.spec.ts >> Note swipe-to-delete on profile page >> full swipe on a note opens the confirm dialog
- Location: tests/swipe-to-delete.spec.ts:179:7
