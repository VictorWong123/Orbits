...
- Name: swipe-to-delete.spec.ts >> Profile card swipe-to-delete >> short swipe (below threshold) does not open the confirm dialog
- Location: tests/swipe-to-delete.spec.ts:134:7
